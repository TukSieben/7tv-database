...
function getPaint() {
    ...
    const elements = {
        ...
        paintDisplay: document.getElementById('paint-display'),
    ...
    if (!paintID) {
        ...
        document.title = `7TV Database │ Paint Viewer`;
        return;
    }

    elements.loading.style.display = 'flex';
    elements.error.style.display = 'none';
    elements.paintDisplay.style.display = 'none';
    document.title = `7TV Database │ Loading Paint...`;
    ...
    function showError() {
        ...
        document.title = `7TV Database │ Paint nicht gefunden`;
    }
}
